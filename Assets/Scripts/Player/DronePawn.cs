...
public class DronePawn : Pawn
{
    ...
    void Start()
    {
        ...
        menuManager.SetCrossair(MenuManager.CrossairStyle.DEFAULT);
    }
    ...
    public override void CustomUpdate()
    {
        ...
        {
            // Translation
            translation = GetInputTranslationDirection() * 0.6f * Time.deltaTime;
        ...
        if (Utility.HasFlag(PlayerManager.Instance.controller.option, (int)PlayerController.Option.ACTION))
        {
            if (Input.GetMouseButtonDown(0))
                MenuManager.Instance.hotBar.selectedItem.item?.Place();
